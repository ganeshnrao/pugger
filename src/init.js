...
module.exports = async siteName => {
  ...
  await exec('npm install', { cwd: dest }).catch(error => {
    logger.error(error, `* Failed to install dependencies, please install using "npm install"`)
  })
  logger.log(`* Pugger site initialized. Use "cd ${cleanSiteName}" to get started.`)
}
